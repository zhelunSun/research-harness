...
1. 总题目和三项标题：已固定为工作版本；
2. 开题证据矩阵 v0.1：已建立，等待异步纠错；
3. URSA 最小 pilot：可立即开始；
4. Chapter 2 comparator/contract：与研究者文献阅读并行；
5. Chapter 3 evaluation brief：可立即设计，真实用户运行等待 Gate B；
6. 正式中文节级大纲：以上最小证据闭环后创建。
