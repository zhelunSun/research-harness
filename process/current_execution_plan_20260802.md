...
执行与汇报对齐（CTRL-20260904-02）：让开题从“有很多材料和原型”成为“研究者能解释、能检验，
也知道风险在哪里的研究路线”。这是管理原则，不是新论文 claim 或优先级调整；沿用协作协议
§6.2–6.2.1，以弄清的问题、依据、剩余不确定性和下一步价值组织节点汇报，分流需决定、值得理解
与按需追溯的内容。当前研究动作、既有授权和实验门禁仍以下文为准；正在逐句审阅的固定候选
不因管理升级重写。无需为每份产物新增人工审核，可让多条已授权并行线服务同一问题。
