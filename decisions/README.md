...
> 当前版本：`idea-v2026.08.02`
> 用途：提供简洁的现行决策入口；决策正文按时间保留，不覆盖历史。

| 决策 | 状态 | 当前作用 | 后续关系 |
| --- | --- | --- | --- |
| `DEC-2026-0717-three-layer-storyline.md` | 部分被替代 | 保留规划与科学约束的递进关系 | 第三项“场景应用”由 `DEC-2026-0729` 替代 |
...
| `DEC-2026-0902-opening-urban-forest-problem-framing.md` | 现行 | 将开题问题链改为由城市森林科研与管理需求牵引，并明确第三项的共享城市制品与复合任务边界 | 三项工作标题在当前开题阶段固定；不冻结最终论文题目，不把“城市级”本身写成创新 |
| `DEC-2026-0902-ch3-routeb-first-evaluation-order.md` | 现行 | 接受 Route B 只读离线治理链作为第三项研究的首个最小评测实现 | 核心栖息地与 RSS 保留为后续任务族；不冻结完整方法、不启动实验或接受新颖性 |
...
“未收到导师新增意见”只表示当前框架可继续推进；不得改写为导师正式批准所有方法
claim、实验方案或最终送审题目。
