...
6. 按所写章节进入下方对应的“章节材料包”，不要先扫描历史计划或聊天记录。
...
| 研究内容三：面向城市森林遥感任务的智能体系统评测 | 多阶段依赖、任务链组织和分层系统评测；下一步开展资产—评测—结论核对 | [`../../urbfo-agent-demo/docs/plans/ch3_asset_eval_claim_audit_handoff_20260831.md`](../../urbfo-agent-demo/docs/plans/ch3_asset_eval_claim_audit_handoff_20260831.md)、[`../../urbfo-agent-demo/docs/reports/asset_inventory_agent_readiness_20260829.md`](../../urbfo-agent-demo/docs/reports/asset_inventory_agent_readiness_20260829.md) | [`../../urbfo-agent-demo/docs/plans/ch3_asset_to_eval_and_hitl_plan_20260731.md`](../../urbfo-agent-demo/docs/plans/ch3_asset_to_eval_and_hitl_plan_20260731.md)、[`../decisions/DEC-2026-0831-opening-consensus-and-working-titles.md`](../decisions/DEC-2026-0831-opening-consensus-and-working-titles.md) |
